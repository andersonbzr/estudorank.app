module.exports = [
"[project]/.next-internal/server/app/api/account/delete/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/account/delete/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** Extrai access_token dos cookies do Supabase (sb-<ref>-auth-token) */ function tokenFromSupabaseCookie(cookieHeader) {
...
/** Extrai token do header Authorization: Bearer x */ function tokenFromAuthHeader(req) {
...
async function POST(req) {
    try {
        ...
        const userClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(url, anon, {
            auth: {
        ...
        if (userErr || !uid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "unauthorized_bad_token"
            }, {
                status: 401
            });
        }
        // Admin client (service role) para deletar dados + usuário
        const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(url, serviceRole, {
            auth: {
                persistSession: false
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d3f20fc._.js.map