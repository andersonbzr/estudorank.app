...
function Content() {
    ...
    /* Ação: alternar conclusão de módulo
     ➜ TRIGGER faz: points=10/0 e completed_at agora/null
  */ async function toggleModule(moduleId) {
        ...
        try {
            ...
            // 1) localizar do próprio usuário
            ...
            if (!existing) {
                // 2) concluir (upsert) – gatilho preencherá points/completed_at
                ...
                // 3) desfazer → completed=false (gatilho zera points/completed_at)
                ...
                if (error) {
                    logDeep("[toggleModule] update.error", error);
                    throw error;
                }
                // Alguns cenários de RLS retornam 200 sem row (status 200/204)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb577349._.js.map