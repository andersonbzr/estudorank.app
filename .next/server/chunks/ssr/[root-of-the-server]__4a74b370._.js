...
"[project]/src/app/u/[username]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function load() {
            ...
            if (c1.error || m1.error || p1.error) {
                setMsg(c1.error?.message || m1.error?.message || p1.error?.message || "Erro ao carregar dados.");
            }
            setCourses(c1.data ?? []);
            setModules(m1.data ?? []);
            setProgress(p1.data ?? []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4a74b370._.js.map