...
"[project]/src/app/u/[username]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = DonutProgress;
/* Skeletons (shimmer) para a tabela de cursos */ function SkeletonBlock(param) {
    let { className = "" } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
/* Linha de progresso horizontal (tabela) */ function LineProgress(param) {
    let { value } = param;
        ...
        "Content.useEffect": ()=>{
            ...
            async function load() {
                ...
                const [c1, m1, p1] = await Promise.all([
                    ...
                    // 🔑 pega progresso SOMENTE do usuário logado
                    supabase.from("progress").select("id, user_id, module_id, completed, points, completed_at").eq("user_id", userId)
                ]);
                if (c1.error || m1.error || p1.error) {
                    var _c1_error, _m1_error, _p1_error;
                    setMsg(((_c1_error = c1.error) === null || _c1_error === void 0 ? void 0 : _c1_error.message) || ((_m1_error = m1.error) === null || _m1_error === void 0 ? void 0 : _m1_error.message) || ((_p1_error = p1.error) === null || _p1_error === void 0 ? void 0 : _p1_error.message) || "Erro ao carregar dados.");
                }
                var _ref;
                ...
                children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SkeletonCoursesTable, {
                        ...
                        children: courses.map((c)=>{
                            const courseModules = modules.filter((m)=>m.course_id === c.id && m.is_active !== false);
                            const totalRaw = courseModules.length; // total real de módulos ativos
                            ...
                            // maior completed_at do curso (do usuário)
                            let last = null;
...
_s1(Content, "d2mUdMYD3/SgtiLahxAzeLD59a0=", false, function() {
    return [
...
//# sourceMappingURL=src_f20708b9._.js.map