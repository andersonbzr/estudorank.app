...
function Content() {
        ...
        "Content.useEffect": ()=>{
            ({
                "Content.useEffect": async ()=>{
                    ...
                    const { data: p } = await supabase.from("profiles").select("full_name, theme").eq("id", user.id).single();
                    var _p_full_name, _ref;
                    const next = {
                        full_name: (_p_full_name = p === null || p === void 0 ? void 0 : p.full_name) !== null && _p_full_name !== void 0 ? _p_full_name : "",
                        theme: (_ref = p === null || p === void 0 ? void 0 : p.theme) !== null && _ref !== void 0 ? _ref : "system"
                    };
                    setProfile(next);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTheme"])(next.theme || "system");
                    setLoading(false);
                }
            })["Content.useEffect"]();
        }
    ...
    function handleThemeChange(newTheme) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTheme"])(newTheme);
        try {
    ...
    async function save() {
        ...
        try {
            var _udata_user;
            const { data: udata } = await supabase.auth.getUser();
            const uid = (_udata_user = udata.user) === null || _udata_user === void 0 ? void 0 : _udata_user.id;
            if (!uid) throw new Error("Sessão inválida.");
            var _profile_full_name, _profile_theme;
            const payload = {
                full_name: ((_profile_full_name = profile.full_name) !== null && _profile_full_name !== void 0 ? _profile_full_name : "").trim() || null,
                theme: (_profile_theme = profile.theme) !== null && _profile_theme !== void 0 ? _profile_theme : "system"
            };
            const { error } = await supabase.from("profiles").update(payload).eq("id", uid);
            if (error) throw error;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTheme"])(payload.theme);
            ...
            var _e_message;
            setMsg((_e_message = e.message) !== null && _e_message !== void 0 ? _e_message : "Não foi possível salvar.");
    ...
    var _profile_theme;
    // Badge “Ativo”
    const themeBadge = ((_profile_theme = profile.theme) !== null && _profile_theme !== void 0 ? _profile_theme : "system") !== "system" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: "ml-2 inline-flex items-center rounded-full border border-white/10 bg-[var(--accent)]/15 px-2 py-0.5 text-xs text-[var(--accent)]",
        children: "Ativo"
    }, void 0, false, {
        fileName: "[project]/src/app/config/page.tsx",
        lineNumber: 135,
    ...
    async function deleteAccount() {
        ...
        try {
            ...
            const token = (_sessionData_session = sessionData.session) === null || _sessionData_session === void 0 ? void 0 : _sessionData_session.access_token;
            ...
            if (!res.ok) {
                ...
                throw new Error((j === null || j === void 0 ? void 0 : j.error) || "HTTP ".concat(res.status));
            }
            ...
            var _e_message;
            toast.push((_e_message = e.message) !== null && _e_message !== void 0 ? _e_message : "Falha ao excluir conta.");
        } finally{
            setDeleting(false);
        }
    }
    var _profile_full_name, _profile_theme1;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "jsx-19baf51b350621da" + " " + "max-w-3xl mx-auto px-4 py-6 lg:py-8",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                className: "jsx-19baf51b350621da" + " " + "text-2xl font-semibold bg-gradient-to-r from-lime-400 to-indigo-500 bg-clip-text text-transparent",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "jsx-19baf51b350621da" + " " + "mt-2 text-sm opacity-80",
                children: "Personalize seu perfil e preferências."
            }, void 0, false, {
                fileName: "[project]/src/app/config/page.tsx",
                lineNumber: 174,
                columnNumber: 7
            ...
            msg && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-19baf51b350621da" + " " + "mt-4 p-3 rounded-xl border border-white/10 bg-white/10 text-sm",
                children: msg
            }, void 0, false, {
                fileName: "[project]/src/app/config/page.tsx",
                lineNumber: 177,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "jsx-19baf51b350621da" + " " + "mt-6 rounded-2xl border border-white/10 bg-[var(--surface)]/70 p-4 transition-all duration-200 ease-out relative",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-19baf51b350621da" + " " + "absolute left-0 right-0 top-0 h-[2px] bg-[var(--accent)]/60 rounded-t-2xl"
                    }, void 0, false, {
                        fileName: "[project]/src/app/config/page.tsx",
                        lineNumber: 184,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "jsx-19baf51b350621da" + " " + "text-lg font-semibold flex items-center gap-2",
                        children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-19baf51b350621da" + " " + "mt-3",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Spinner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            label: "Carregando..."
                        }, void 0, false, {
                            fileName: "[project]/src/app/config/page.tsx",
                        ...
                        className: "jsx-19baf51b350621da" + " " + "mt-3 grid gap-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-19baf51b350621da",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        className: "jsx-19baf51b350621da" + " " + "block text-sm mb-1",
                                        children: "E-mail"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/config/page.tsx",
                                        lineNumber: 197,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        value: email,
                                        disabled: true,
                                        className: "jsx-19baf51b350621da" + " " + "w-full field opacity-70 transition-all duration-200 ease-out"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/config/page.tsx",
                                        lineNumber: 198,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        value: (_profile_full_name = profile.full_name) !== null && _profile_full_name !== void 0 ? _profile_full_name : "",
                                        onChange: (e)=>setProfile((p)=>({
                                                    ...p,
                                                    full_name: e.target.value
                                                })),
                                        placeholder: "Como você quer aparecer",
                                        className: "jsx-19baf51b350621da" + " " + "w-full field transition-all duration-200 ease-out"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/config/page.tsx",
                                        lineNumber: 203,
                                        columnNumber: 15
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        className: "jsx-19baf51b350621da" + " " + "mt-3 grid gap-4 sm:grid-cols-2",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-19baf51b350621da",
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        value: (_profile_theme1 = profile.theme) !== null && _profile_theme1 !== void 0 ? _profile_theme1 : "system",
                                        onChange: (e)=>handleThemeChange(e.target.value),
                                        className: "jsx-19baf51b350621da" + " " + "w-full field transition-all duration-200 ease-out",
                                        children: THEMES.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: t.value,
                                                className: "jsx-19baf51b350621da",
                                                children: t.label
                                            }, t.value, false, {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "jsx-19baf51b350621da" + " " + "mt-1 text-xs opacity-70",
                                        children: "“Sistema” segue o tema do seu dispositivo."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/config/page.tsx",
                                        lineNumber: 243,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-19baf51b350621da" + " " + "hidden sm:block"
                            }, void 0, false, {
                                fileName: "[project]/src/app/config/page.tsx",
                                lineNumber: 245,
                                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-19baf51b350621da" + " " + "mt-6 flex items-center justify-end gap-3",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$MotionButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    children: saveState === "saving" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "jsx-19baf51b350621da" + " " + "inline-flex items-center gap-2",
                        children: [
                        ...
                        lineNumber: 259,
                        columnNumber: 13
                    }, this) : saveState === "success" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "jsx-19baf51b350621da" + " " + "inline-flex items-center gap-2 animate-[fadeout_1.2s_ease-in_forwards]",
                        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "jsx-19baf51b350621da" + " " + "mt-10 rounded-2xl border border-red-500/30 bg-red-500/[0.06] p-4 relative",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-19baf51b350621da" + " " + "absolute left-0 right-0 top-0 h-[2px] bg-red-500/70 rounded-t-2xl"
                    }, void 0, false, {
                        fileName: "[project]/src/app/config/page.tsx",
                        lineNumber: 276,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        className: "jsx-19baf51b350621da" + " " + "text-base font-semibold flex items-center gap-2 text-red-300",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShieldAlert$3e$__["ShieldAlert"], {
                                size: 16
                            }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "jsx-19baf51b350621da" + " " + "mt-1 text-sm opacity-80",
                        children: [
                            "Excluir sua conta é ",
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "jsx-19baf51b350621da" + " " + "font-semibold",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-19baf51b350621da" + " " + "mt-3 grid sm:grid-cols-[1fr_auto] gap-3 items-center",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                value: confirmText,
                                onChange: (e)=>setConfirmText(e.target.value),
                                placeholder: 'Digite "DELETAR" para confirmar',
                                className: "jsx-19baf51b350621da" + " " + "field w-full"
                            }, void 0, false, {
                                fileName: "[project]/src/app/config/page.tsx",
                                lineNumber: 287,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "jsx-19baf51b350621da" + " " + "btn-danger px-4 py-2 inline-flex items-center gap-2",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "19baf51b350621da",
                children: "@keyframes fadeout{0%{opacity:1;transform:translateY(0)}60%{opacity:1}to{opacity:0;transform:translateY(-4px)}}"
...
_s(Content, "ELo8JHfsBIehMBSkWULm98nTc5s=", false, function() {
    return [
...
//# sourceMappingURL=src_8365d406._.js.map