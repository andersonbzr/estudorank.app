  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl p-6 md:p-8 bg-gradient-to-b from-neutral-900/95 to-black/90 backdrop-blur-md shadow-[inset_0_0_0_1px_rgba(255,255,255,0.05)] border border-white/10">
          {/* aurora */}
          <motion.div
          ...
          <div className="relative z-10">
            ...
            <p className="mt-1 text-sm text-white/70">Perfil e segurança.</p>
          </div>
          ...
          <div className="relative z-10 border-t border-white/5 mt-6 pt-6">
            ...
            <div className="grid gap-4">
              ...
              <div>
                <label htmlFor="displayName" className="block text-sm opacity-70 mb-1">
                  Nome de exibição
                </label>
          ...
          <div className="relative z-10 border-t border-white/5 mt-6 pt-6">
            ...
            <div className="grid gap-4">
              {/* senha atual */}
              <div>
                <label htmlFor="curPass" className="block text-sm opacity-70 mb-1">
                  Senha atual
                </label>
                <div className="relative">
                  <input
              ...
              {/* nova senha */}
              <div>
                <label htmlFor="newPass" className="block text-sm opacity-70 mb-1">
                  Nova senha
                </label>
                <div className="relative">
                  <input
              ...
              {/* confirmar senha */}
              <div>
                <label htmlFor="confPass" className="block text-sm opacity-70 mb-1">
          ...
          {/* Sem Zona de Perigo — exclusão de conta removida */}
        </div>
      </div>
    </motion.main>
  );
